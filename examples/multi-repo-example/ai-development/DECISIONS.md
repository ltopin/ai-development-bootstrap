...
|---|---|---|---|---|---|---|
| `notifications.email-provider` | Notifications — transactional email | Provider X (fictional) | ACTIVE | 2026-03-02 | `alice` | Answer to question Q1 in the add-order-cancellation PR; cheapest option meeting the volume; no ADR needed |

Statuses: `ACTIVE`, `Superseded by …`, `Revoked`.
